<?php
namespace Chilliapple\Customizeproducts\Block\Adminhtml\Productcategory;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_productcategory';
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('checkmodule_checkmodel')->getId()) {
            return __("Edit Category '%1'", $this->escapeHtml($this->_coreRegistry->registry('checkmodule_checkmodel')->getTitle()));
        } else {
